...
public class CustomersDAO implements ICustomersDAO {
    ...
    public Customers getById(int id) {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM customers WHERE idcustomers=" + id);
            if (resultSet.next()) {
    ...
    public void update(Customers customers) {
        Connection connection = ConnectionUtil.getConnection();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE customers SET customerName=?, " +
